...
public class InvestissementController {
    ...
    @Operation(
        ...
        description = "Soumet un nouvel investissement sur un projet. L'identifiant de l'investisseur est extrait automatiquement du token JWT. Le statut initial est EN_ATTENTE jusqu'à validation par un administrateur.",
        tags = {"Investissements"}
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Investissement créé en attente de validation",
    ...
    @SecurityRequirement(name = "BearerAuth")
    @Operation(
        summary = "Modifier un investissement",
        description = "Modifie un investissement existant. Accessible à l'administrateur ou à l'investisseur propriétaire tant que l'investissement est en statut EN_ATTENTE.",
        tags = {"Investissements"}
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Investissement modifié avec succès",
            content = @Content(mediaType = "application/json",
                schema = @Schema(implementation = ApiResponseDTO.class))),
        @ApiResponse(responseCode = "401", description = "Token JWT manquant ou invalide",
            content = @Content(schema = @Schema(implementation = ApiResponseDTO.class))),
        @ApiResponse(responseCode = "403", description = "Accès refusé — non propriétaire ou statut non modifiable",
            content = @Content(schema = @Schema(implementation = ApiResponseDTO.class)))
    })
    public ApiResponseDTO<InvestissementDTO> update(
            @Parameter(description = "Identifiant de l'investissement à modifier", example = "15", required = true)
    ...
    @SecurityRequirement(name = "BearerAuth")
    @Operation(
        summary = "Mes investissements",
        description = "Retourne la liste de tous les investissements de l'utilisateur connecté, avec le détail des dividendes et du ROI.",
        tags = {"Investissements"}
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Liste des investissements de l'utilisateur",
            content = @Content(mediaType = "application/json",
                schema = @Schema(implementation = ApiResponseDTO.class))),
        @ApiResponse(responseCode = "401", description = "Token JWT manquant ou invalide",
            content = @Content(schema = @Schema(implementation = ApiResponseDTO.class)))
    ...
    @SecurityRequirement(name = "BearerAuth")
    @Operation(
        summary = "[Admin] Lister tous les investissements",
        description = "Retourne la liste complète de tous les investissements de la plateforme. Réservé aux administrateurs.",
        tags = {"Investissements"}
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Liste complète des investissements",
            content = @Content(mediaType = "application/json",
                schema = @Schema(implementation = ApiResponseDTO.class))),
    ...
    @Operation(
        ...
        description = "Retourne le détail complet d'un investissement. Accessible à l'administrateur ou à l'investisseur propriétaire.",
        tags = {"Investissements"}
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Détail de l'investissement",
            content = @Content(mediaType = "application/json",
                schema = @Schema(implementation = ApiResponseDTO.class))),
    ...
    @SecurityRequirement(name = "BearerAuth")
    @Operation(
        summary = "[Admin] Valider un investissement",
        description = "Valide un investissement en statut EN_ATTENTE, génère le contrat et l'envoie par email à l'investisseur. Réservé aux administrateurs.",
        tags = {"Investissements"}
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Investissement validé et contrat envoyé",
            content = @Content(mediaType = "application/json",
                schema = @Schema(implementation = ApiResponseDTO.class))),
        @ApiResponse(responseCode = "403", description = "Accès refusé — rôle ADMIN requis",
            content = @Content(schema = @Schema(implementation = ApiResponseDTO.class))),
    ...
    @SecurityRequirement(name = "BearerAuth")
    @Operation(
        summary = "[Admin] Annuler un investissement",
        description = "Annule un investissement et restitue les fonds à l'investisseur. Réservé aux administrateurs.",
        tags = {"Investissements"}
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Investissement annulé",
            content = @Content(mediaType = "application/json",
                schema = @Schema(implementation = ApiResponseDTO.class))),
        @ApiResponse(responseCode = "403", description = "Accès refusé — rôle ADMIN requis",
            content = @Content(schema = @Schema(implementation = ApiResponseDTO.class)))
    ...
    @SecurityRequirement(name = "BearerAuth")
    @Operation(
        summary = "[Admin] Supprimer un investissement",
        description = "Supprime définitivement un investissement de la base de données. Action irréversible. Réservé aux administrateurs.",
        tags = {"Investissements"}
    )
    @ApiResponses(value = {
