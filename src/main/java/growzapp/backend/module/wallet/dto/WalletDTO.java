...
public record WalletDTO(
        ...
        @Schema(description = "Solde bloqué en attente de validation (investissement en attente) ou séquestré (wallet projet)", type = "number", format = "double", example = "200.00")
